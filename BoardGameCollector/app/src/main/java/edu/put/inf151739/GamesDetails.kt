...
class GamesDetails : AppCompatActivity() {
    ...
    private val gamesTable by lazy { findViewById<TableLayout>(R.id.games_table) }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        gamesList = db.findAllGames().toMutableList()
        populateGamesTable()
    ...
    private fun populateGamesTable() {
        // Pobierz szerokości kolumn z nagłówka
        ...
        for (i in columnWidths.indices) {
            ...
            // Ustawienie pogrubienia dla nagłówka
        ...
        for (game in gamesList) {
            ...
            row.setOnClickListener {
                // Przejście do DetailsView dla wybranego wiersza
            ...
            for (i in columnWidths.indices) {
                val cellView = when (i) {
                    ...
                    3 -> {
                        ...
                        // Puste pole dla nieznanej kolumny
                        View(this)
                    }
                }
    ...
    private fun updateGamesTable(sortedList: List<Game?>) {
        gamesList.clear()
